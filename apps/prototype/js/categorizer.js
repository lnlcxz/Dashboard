...
const DEFAULT_RULES = [
  ...
  // Compras
  { pattern: /mercado\s*livre|amazon|shopee|aliexpress|magalu|magazine|americanas|casas\s*bahia|extra\.com|kabum|ponto\s*frio/i, category: 'Compras Online', icon: '🛍️' },
...
const CATEGORY_COLORS = {
  ...
  'Lazer': '#e879f9',
  'Financeiro': '#6366f1',
  'Transferência Recebida': '#22c55e',
  'Transferência Enviada': '#ef4444',
  'Salário': '#10b981',
  'Outros': '#64748b',
};
...
export function getAllCategories() {
  ...
  return cats.map(c => ({ name: c, color: CATEGORY_COLORS[c] }));
}

export function applyCategories(transactions) {
